...
import oprag.project.gestionControleDAcces.email.EmailResponse;
...
public class EmailService {
    ...
    private final String username = "adralabel@gmail.com";
    private final String password = "qyhbvxdxzbxpgmih";
    @Autowired
